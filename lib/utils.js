...
exports.toCSV = async function(prompt, results){
  ...
  this.writeToTemp(`results.csv`, csv)
  return fileName;
}
...
exports.toJSON= function(prompt, results){
  ...
  this.writeToTemp(`results.json`,JSON.stringify(results, null, 2))
}
...
exports.toText= function(prompt, results){
  ...
  this.writeToTemp(`results.txt`,ascii)
}
...
exports.tempfileInEditor = function(fileName){
  ...
  const isOpen =  vscode.window.activeTextEditor.document.fileName === tempFile;
  return isOpen
}
